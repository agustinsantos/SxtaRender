...
#define READALL
// un-comment so ALL fields read from file are interpreted and filled. Necessary to implement uncompressed DDS
...
namespace Sxta.Render.OpenGLExt
{
    ...
    public static class ImageDDS
    {
        ...
        public static Texture LoadFromDisk(string filename, Texture.Parameters @params)
        {
            uint texturehandle;
