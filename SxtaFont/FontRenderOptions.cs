...
namespace SxtaRender.Fonts
{
    ...
    public class FontRenderOptions
    {
        ...
        /// the Font to have been loaded with a drop shadow to
        /// take effect.
        /// </summary>
        ...
        /// </summary>
        public Vector2f DropShadowOffset = new Vector2f(0.16f, 0.16f);
        ...
        /// Font.Begin() / Font.End(); however, this means working in a coordinate 
        ...
        /// 
        /// One option is simply not to call Font.Begin() / Font.End(). This
        ...
        ///    compyFontSmall = new Font("Data/comfy.ttf", 14 * fontScale);
        /// 
        /// 
        /// </summary>
