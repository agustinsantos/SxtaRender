...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Learning 2.06: Interface Blocks", ExampleCategory.Learning, "2. Shaders", 1, Source = "Tutorial02_6", Documentation = "Tutorial02_6")]
    public class TutorialLearning02_6 : GameWindow
    {
        public TutorialLearning02_6()
            : base(600, 600)
        {
        ...
        {
            using (TutorialLearning02_6 example = new TutorialLearning02_6())
            {
