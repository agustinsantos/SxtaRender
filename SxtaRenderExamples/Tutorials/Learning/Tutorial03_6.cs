...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Example 3.6: Perspective Matrix", ExampleCategory.Learning, "3. Math: Matrix operations", 1, Source = "Tutorial03_6", Documentation = "Tutorial03_6")]
    public class TutorialLearning03_6 : GameWindow
    {
        public TutorialLearning03_6()
            : base(600, 600)
        {
        ...
        {
            using (TutorialLearning03_6 example = new TutorialLearning03_6())
            {
