...
{
    /// <summary>
    /// Demonstrates how to work with multiple uniform variables.
    /// </summary>
    [Example("Learning 2.10: Uniform Variables (IV)", ExampleCategory.Learning, "2. Shaders", 1, Source = "Tutorial02_10", Documentation = "Tutorial02_10")]
    public class TutorialLearning02_10 : GameWindow
    {
        public TutorialLearning02_10()
            : base(600, 600)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Load up a triangle
            triangle.addVertex(new Vertex_V2C3f() { Position = new Vector2f(0.0f, 0.3f), Color = new Vector3f(1.0f, 1.0f, 1.0f) });
            triangle.addVertex(new Vertex_V2C3f() { Position = new Vector2f(0.3f, -0.3f), Color = new Vector3f(1.0f, 1.0f, 1.0f) });
            triangle.addVertex(new Vertex_V2C3f() { Position = new Vector2f(-0.3f, -0.3f), Color = new Vector3f(1.0f, 1.0f, 1.0f) });
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            uOffset.set(new Vector2f(0.7f, 0.5f));
            uColor.set(new Vector3f(1.0f, 0.0f, 0.0f));
            fb.draw(p, triangle);

            // Render second triangle
            uOffset.set(new Vector2f(0.0f, -0.5f));
        ...
        {
            using (TutorialLearning02_10 example = new TutorialLearning02_10())
            {
