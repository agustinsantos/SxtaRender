...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Example 4.11: Drawing Curved 3D", ExampleCategory.Learning, "4. Drawing", 1, Source = "Tutorial04_11", Documentation = "Tutorial04_11")]
    public class TutorialLearning04_11 : GameWindow
    {
        public TutorialLearning04_11()
            : base(600, 600)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Model 2. Sphere 
            mesh2 = MeshUtils.GenerateSolidSphere(1.0, 20, 20);
            // Model 3. Cone 
            mesh3 = MeshUtils.GenerateSolidCone(1.0, 2.0, 20, 20);
            // Model 4. Cylinder 
            mesh4 = MeshUtils.GenerateSolidCylinder(1.0, 1.0, 20, 20);
            // Model 5. Torus 
            mesh5 = MeshUtils.GenerateSolidTorus(0.5, 1.0, 20, 20);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            mat = camera * Matrix4f.CreateTranslation(0.5f, 3.0f, 0.0f) * Matrix4f.CreateRotation(angle * 3, 0.0f, 1.0f, 0.5f)  ;
            uMVMatrix.set(mat);
            fb.draw(p, mesh2);

            mat = camera * Matrix4f.CreateTranslation(5.0f, 3.0f, 0.0f) * Matrix4f.CreateRotation(angle * 3, 0.0f, 1.0f, 0.5f)  ;
            uMVMatrix.set(mat);
            fb.draw(p, mesh3);

            mat = camera * Matrix4f.CreateTranslation(0.5f, 0.0f, 0.0f) * Matrix4f.CreateRotation(angle * 3, 0.0f, 1.0f, 0.5f) ;
            uMVMatrix.set(mat);
            fb.draw(p, mesh4);

            mat = camera * Matrix4f.CreateTranslation(5.0f, 0.0f, 0.0f) * Matrix4f.CreateRotation(angle * 3, 0.0f, 1.0f, 0.5f)  ;
            uMVMatrix.set(mat);
            fb.draw(p, mesh5);
        ...
        Mesh<Vertex_V3N3T2f, ushort> mesh2, mesh3, mesh4, mesh5;
        Matrix4f mat;
        ...
        {
            using (TutorialLearning04_11 example = new TutorialLearning04_11())
            {
