...
{
    /// <summary>
    /// Demonstrates how to render a Teapot model
    /// </summary>
    [Example("Example 4.13: Drawing a Teapot model", ExampleCategory.Learning, "4. Drawing", 1, Source = "Tutorial04_13", Documentation = "Tutorial04_13")]
    public class TutorialLearning04_13 : GameWindow
    {
        public TutorialLearning04_13()
            : base(600, 600)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Model 2. Teapot
            mesh2 = Teapot.GenerateSolidTeapot(1.0);

            // Model 3. Teacup
            mesh3 = Teapot.GenerateSolidTeacup(1.0);

            // Model 4. Teaspoon
            mesh4 = Teapot.GenerateSolidTeaspoon(1.0);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4f camera = Matrix4f.CreateTranslation(-3.0f, -2.0f, -7.0f);

            mat = camera * Matrix4f.CreateTranslation(3.0f, 1.0f, 0.0f) * Matrix4f.CreateRotationY(angle);
            uMVMatrix.set(mat);
            fb.draw(p, mesh2);

            mat = camera * Matrix4f.CreateTranslation(0.0f, 1.0f, 0.0f) * Matrix4f.CreateRotationY(angle);
            uMVMatrix.set(mat);
            fb.draw(p, mesh3);

            mat = camera * Matrix4f.CreateTranslation(6.0f, 1.0f, 0.0f) * Matrix4f.CreateRotationY(angle);
            uMVMatrix.set(mat);
            fb.draw(p, mesh4);
        ...
        Mesh<Vertex_V3N3T2f, ushort> mesh2, mesh3, mesh4;
        Matrix4f mat;
        ...
        {
            using (TutorialLearning04_13 example = new TutorialLearning04_13())
            {
