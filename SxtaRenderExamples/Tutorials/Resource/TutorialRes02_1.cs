...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Example 2.1: Mesh Resource (Cube)", ExampleCategory.Resource, "2. Mesh Resource", 1, Source = "TutorialRes02_1", Documentation = "Tutorial-TODO")]
    public class TutorialRes02_1 : GameWindow
    {
        public TutorialRes02_1()
            : base(600, 600)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            res = (MeshResource)resManager.loadResource("cube.mesh");
        ...
        {
            using (TutorialRes02_1 example = new TutorialRes02_1())
            {
