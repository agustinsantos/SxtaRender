...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Example 1.1: 2D Texture Resource", ExampleCategory.Resource, "1. Texture Resource", 1, Source = "TutorialRes01_1", Documentation = "Tutorial-TODO")]
    public class TutorialRes01_1 : GameWindow
    {
        public TutorialRes01_1()
            : base(600, 600)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            textres = ((Texture2DResource)(resManager.loadResource("checker")));
            p.getUniformSampler("gSampler").set((Texture)textres.get());
        ...
        {
            using (TutorialRes01_1 example = new TutorialRes01_1())
            {
