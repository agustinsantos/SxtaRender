...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Example 3.2: Module Resource Vertex+Fragment", ExampleCategory.Resource, "3. Module Resource", 1, Source = "TutorialRes03_2", Documentation = "Tutorial-TODO")]
    public class TutorialRes03_2 : GameWindow
    {
        public TutorialRes03_2()
            : base(600, 600)
        {
        ...
        {
            using (TutorialRes03_2 example = new TutorialRes03_2())
            {
