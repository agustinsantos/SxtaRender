...
namespace Examples.Tutorials
{
    ...
    /// </summary>
    [Example("Example 2.02: Terrain Generation", ExampleCategory.Proland, "02. Proland Terrain", 1, Source = "Tutorial02_02", Documentation = "Tutorial02_02")]
    public class TutorialProland02_2 : GameWindow
    {
        public TutorialProland02_2(string wd) : base(600, 600)
        {
        ...
        {
            using (TutorialProland02_2 example = new TutorialProland02_2("Resources/Proland/Terrain/Example02"))
            {
                example.Run(60.0);
            }
        }
